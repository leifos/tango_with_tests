...
class Chapter16ViewTests(TestCase):
    ...
    def DONTtest_link_to_edit_profile_in_index(self):
    ...
    def DONTtest_registration_redirects_to_profile_form_after_registration(self):
        #  Register user
...
class Chapter16LiveServerTestCase(StaticLiveServerTestCase):
    ...
    def DONTtest_users_can_edit_only_their_own_page(self):
        pass
